...
- Ready:
  - Add richer TUI and CLI/SDK controls for web-search `user_location`, future schema-backed `filters`, OpenRouter-specific `engine` / `max_results` / `max_total_results` / domain filters, and route-specific model-picker chips.
