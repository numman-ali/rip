...
- Ready:
  ...
  - Lift currently documented-only request knobs into real runtime/config surface where appropriate: reasoning controls, multimodal/image/file inputs, hosted tools, and MCP request composition.
