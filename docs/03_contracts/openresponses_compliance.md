...
- ResponseResource validation tests cover tool_choice variants (including allowed_tools + value enum), Tool union variants, and MCPListTools output items; MemoryToolParam schema is validated directly.
