...
- SDK transports + distribution: direct-HTTP, bundled binaries, and additional language SDKs
- Terminal UI (TUI): richer interaction layer (palette/editor/threads) over the same event frames
