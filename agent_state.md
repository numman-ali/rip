...
- Known OpenResponses gap: compatibility profiles now describe reasoning/multimodal/hosted-tool request health, but RIP does not yet expose those as first-class operator-configurable request fields in its own runtime/config surface.
